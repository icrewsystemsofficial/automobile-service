...
<!-- <section>
    <div class="container">
        <h1 class="text-center py-4" style="font-size: 45px;">Why Choose Us</h1>
        <div class="row">
          <div class="col">
            <div class="col-md-4">
              <img src="{{ asset('theme/assets/images/icons/hand-heart.svg') }}" alt="">
              </div>
                <div class="col-md-4">
                  <h5>Friendly & Honest Service</h5>
                </div>
          </div>
          <div class="col">
            <div class="col-md-4">
              <img src="{{ asset('theme/assets/images/icons/award.svg') }}" alt="">
              </div>
                <div class="col-md-2">
                  <h5>Friendly & Honest Service</h5>
                </div>
